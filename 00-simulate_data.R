...
### Simulate 5 Most Frequent Fire Inspection Violation Codes ####
set.seed(250)
simulated_data_codes <-
  tibble(
    # Assign 5 codes as most frequent 
    Code = sample(
      x = c("1.1.2.1", "2.2.3.2", "2.4.1.1", "2.4.1.3", "6.2.1.2"),
      size = 5,
      replace = FALSE
    ),
    # Randomly select number of violation code occurences
    Occurence = 
      sample(800:1000, 5, replace = TRUE)
  )
simulated_data_codes
